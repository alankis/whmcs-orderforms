                                            ...
                                            <div class="price" id="product{$product@iteration}-price">
                                                {if $product.bid}
                                                    ...
                                                    {if $product.displayprice}
                                                        <br /><br /><span>{$product.displayprice}</span>
                                                    {/if}
                                                ...
                                                {else}
                                                    {if $product.pricing.hasconfigoptions}
                                                        {$LANG.from}
                                                    {/if}
                                                    <span>{$product.pricing.minprice.price}</span>
                                                    {if $product.pricing.minprice.cycle eq "monthly"}
                                                        <p>{$LANG.orderpaymenttermmonthly}</p>
                                                    {elseif $product.pricing.minprice.cycle eq "quarterly"}
                                                        <p>{$LANG.orderpaymenttermquarterly}</p>
                                                    {elseif $product.pricing.minprice.cycle eq "semiannually"}
                                                        <p>{$LANG.orderpaymenttermsemiannually}</p>
                                                    {elseif $product.pricing.minprice.cycle eq "annually"}
                                                        <p>{$LANG.orderpaymenttermannually}</p>
                                                    {elseif $product.pricing.minprice.cycle eq "biennially"}
                                                        <p>{$LANG.orderpaymenttermbiennially}</p>
                                                    {elseif $product.pricing.minprice.cycle eq "triennially"}
                                                        <p>{$LANG.orderpaymenttermtriennially}</p>
                                                    {/if}
                                                {/if}
                                            </div>
                                            {if $product.qty eq "0"}
...
{php}
$vars = $template->getTemplateVars('product');
//echo "<pre>";
//print_r($vars);
//echo "</pre>";
{/php}
